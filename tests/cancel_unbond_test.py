...
def test_stake_after_withdraw_period_expired(
    a, deployer, alice, bob, worker, alpha, staking
):
    alice_stake_amt = 10 ** 18
    bob_stake_amt = 3 * 10 ** 18
...
def test_unbond_after_withdraw_period_expired(
    a, deployer, alice, bob, worker, alpha, staking
):
    alice_stake_amt = 10 ** 18
    bob_stake_amt = 3 * 10 ** 18
...
def test_unbond_twice_across_upgrade_period(
    alice, bob, proxy_admin, staking, staking_v2
):
    alice_stake_amt = 10 ** 18
    bob_stake_amt = 3 * 10 ** 18
...
def test_upgrade_and_stake_after_withdraw_period(
    alice, bob, proxy_admin, staking, staking_v2
):
    alice_stake_amt = 10 ** 18
    bob_stake_amt = 3 * 10 ** 18
...
def test_stake_after_new_withdraw_period_expired(
    alice, bob, proxy_admin, staking, staking_v2
):
    alice_stake_amt = 10 ** 18
    bob_stake_amt = 3 * 10 ** 18
...
def test_withdraw_period_expired_then_upgrade_and_stake(
    alice, bob, proxy_admin, staking, staking_v2
):
    alice_stake_amt = 10 ** 18
    bob_stake_amt = 3 * 10 ** 18
...
def test_unbond_then_upgrade_and_stake_staking_v3(
    ...
    staking.stake(alice, 10 ** 18, {"from": alice})
