...
def test_not_enough_alpha_before_upgrade(a, alice, bob, deployer, staking, staking_v2, proxy_admin):
    alice_stake_amt = 10**18
    staking.stake(alice_stake_amt, {'from': alice})
...
def test_extract_before_upgrade(a, deployer, alice, bob, worker, alpha, staking, staking_v2, proxy_admin):
    alice_stake_amt = 10**18
    bob_stake_amt = 3 * 10**18
...
def test_extract_after_upgrade(a, deployer, alice, bob, worker, alpha, upgraded_staking):
    alice_stake_amt = 10**18
    bob_stake_amt = 3 * 10**18
...
def test_extract_during_unbond(a, deployer, alice, bob, worker, alpha, staking):
    ...
    assert (cur_alice_balance - prv_alice_balance) == 75 * \
        10**18, 'incorrect withdraw amount'
    ...
    assert (cur_alice_balance - prv_alice_balance) == 25 * \
        10**18, 'incorrect withdraw amount'
    assert (cur_bob_balance - prv_bob_balance) == 25 * \
        10**18, 'incorrect withdraw amount'


def test_extract_during_unbond_before_upgrade(a, deployer, alice, bob, worker, alpha, staking, staking_v2, proxy_admin):
...
def test_extract_during_unbond_after_upgrade(a, deployer, alice, bob, worker, alpha, upgraded_staking):
...
def test_staking_after_extract(a, deployer, alice, bob, worker, alpha, staking):
    ...
    assert (cur_alice_balance - prv_alice_balance) == 100 * \
        10**18, 'incorrect withdraw amount'
    assert (cur_bob_balance - prv_bob_balance) == 198 * \
        10**18, 'incorrect withdraw amount'


def test_staking_after_extract_before_upgrade(a, deployer, alice, bob, worker, alpha, staking, staking_v2, proxy_admin):
...
def test_staking_after_extract_and_upgrade(a, deployer, alice, bob, worker, alpha, upgraded_staking):
...
def test_withdraw_all_before_upgrade(a, deployer, alice, bob, worker, alpha, staking, staking_v2, proxy_admin):
...
def test_withdraw_all_after_upgrade(a, deployer, alice, bob, worker, alpha, upgraded_staking):
